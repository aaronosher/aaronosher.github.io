...
import "flat-surface-shader-unofficial";
...
(() => {
  ...
  var EXPORT = {
    ...
    export: function () {
      ...
      for (l = scene.lights.length - 1; l >= 0; l--) {
        ...
        x = Math.randomInRange(
          this.width * this.minLightX,
          this.width * this.maxLightX
        );
        y = Math.randomInRange(
          this.height * this.minLightY,
          this.height * this.maxLightY
        );
  ...
  function initialise() {
    ...
    resize(container.offsetWidth, container.offsetHeight);
    animate();
    console.log("initialized", FSS !== undefined);
  }
